...
public class AnimationViewer extends JPanel implements ActionListener {
	...
	public AnimationViewer() {
		...
		Shape ovalText = new OvalShape(0, 0, 2, 3, 25, 25);
		Shape hexagonText = new HexagonShape(0, 0, 6, 3, 80, 80);
		...
		Shape _simpleShape = new DynamicShape(1, 1, -5, 3, 5, 5);
		_midLevelNest.add(_bottomLevelNest);
		_bottomLevelNest.add(_simpleShape);
		_topLevelNest.add(_midLevelNest);
		_topLevelNest.add(ovalText);
		ovalText.addText("TEST");
		hexagonText.addText("Hex");

		// Populate the list of Shapes.
		_shapes.add(new RectangleShape(0, 0, 2, 3));
		_shapes.add(new RectangleShape(10, 10, 4, 2));
		_shapes.add(new OvalShape(20, 20, 3, 5));
		_shapes.add(new HexagonShape(20, 20, 5, 3, 20, 20));
		_shapes.add(new DynamicShape(Color.CYAN));
		_shapes.add(new DynamicShape(20,35,6,4,Color.RED));
		_shapes.add(new HexagonShape(10, 10, 3, 3, 60, 60));
		_shapes.add(_topLevelNest);
		_shapes.add(hexagonText);
